...
void ISR_Handler_divide_error(){ // Interrupt 0x00 - Divide Error
...
void ISR_Handler_debug(){ // Interrupt 0x01 - Debug Exception
    
    // Handle the debug exception here
    
    
}
void ISR_Handler_nmi(){ // Interrupt 0x02 - Non-Maskable Interrupt
    
    // Handle the non-maskable interrupt here
    
    
}
void ISR_Handler_breakpoint(){ // Interrupt 0x03 - Breakpoint Exception
    
    // Handle the breakpoint exception here
    
    
}
void ISR_Handler_overflow(){ // Interrupt 0x04 - Overflow Exception
    
    // Handle the overflow exception here
    
    
}
void ISR_Handler_bound_range_exceeded(){ // Interrupt 0x05 - Bound Range Exceeded
    
    // Handle the bound range exceeded exception here
    
    
}
void ISR_Handler_invalid_opcode(){ // Interrupt 0x06 - Invalid Opcode Exception
...
void ISR_Handler_device_not_available(){ // Interrupt 0x07 - Device Not Available Exception
    
    // Handle the device not available exception here
    
    
}
void ISR_Handler_double_fault(){ // Interrupt 0x08 - Double Fault Exception
...
void ISR_Handler_coprocessor_segment_overrun(){ // Interrupt 0x09 - Coprocessor Segment Overrun
    
    // Handle the coprocessor segment overrun exception here
    
    
}
void ISR_Handler_invalid_tss(){ // Interrupt 0x0A - Invalid TSS Exception
    
    // Handle the invalid TSS exception here
    
    
}
void ISR_Handler_segment_not_present(){ // Interrupt 0x0B - Segment Not Present Exception
    
    // Handle the segment not present exception here
    
    
}
void ISR_Handler_stack_segment_fault(){ // Interrupt 0x0C - Stack Segment Fault
    
    // Handle the stack segment fault exception here
    
    
}
void ISR_Handler_general_protection_fault(){ // Interrupt 0x0D - General Protection Fault
    
    // Handle the general protection fault here
    
    
}
void ISR_Handler_page_fault(){ // Interrupt 0x0E - Page Fault Exception
...
void ISR_Handler_x87_fpu_error(){ // Interrupt 0x10 - x87 FPU Error
    
    // Handle the x87 FPU error here
    
    
}
void ISR_Handler_alignment_check(){ // Interrupt 0x11 - Alignment Check Exception
    
    // Handle the alignment check exception here
    
    
}
void ISR_Handler_machine_check(){ // Interrupt 0x12 - Machine Check Exception
    
    // Handle the machine check exception here
    
    
}
void ISR_Handler_simd_fpu_error(){ // Interrupt 0x13 - SIMD FPU Error
    
    // Handle the SIMD FPU error here
    
    
}
void ISR_Handler_virtualization_exception(){ // Interrupt 0x14 - Virtualization Exception
    
    // Handle the virtualization exception here
    
    
}
void ISR_Handler_security_exception(){ // Interrupt 0x15 - Security Exception
...
void ISR_Handler_timer(){ // Interrupt 0x20 - IRQ0 - Timer Interrupt
...
void ISR_Handler_keyboard() { // Interrupt 0x21 - IRQ1 - Keyboard Interrupt
...
void ISR_Handler_cascade(){ // Interrupt 0x22 - IRQ2 - Cascade Interrupt
...
// IRQ3 - COM2 Interrupt
void ISR_Handler_com2(){ // Interrupt 0x23 - IRQ3 - COM2 Interrupt
...
// IRQ4 - COM1 Interrupt
void ISR_Handler_com1(){ // Interrupt 0x24 - IRQ4 - COM1 Interrupt
...
void ISR_Handler_lpt2(){ // Interrupt 0x25 - IRQ5 - LPT2/Sound Card Interrupt
...
void ISR_Handler_floppy(){ // Interrupt 0x26 - IRQ6 - Floppy Disk Interrupt
...
// IRQ7 - LPT1 Interrupt
void ISR_Handler_lpt1(){ // Interrupt 0x27 - IRQ7 - LPT1 Interrupt
...
void ISR_Handler_rtc(){ // Interrupt 0x28 - IRQ8 - RTC Interrupt
...
// IRQ9 - ACPI Interrupt
void ISR_Handler_acpi(){ // Interrupt 0x29 - IRQ9 - ACPI Interrupt
...
void ISR_Handler_irq10(){ // Interrupt 0x2A - IRQ10 - General Use Interrupt
...
void ISR_Handler_irq11(){ // Interrupt 0x2B - IRQ11 - General Use Interrupt
...
void ISR_Handler_mouse(){ // Interrupt 0x2C - IRQ12 - PS/2 Mouse Interrupt
...
// IRQ13 - FPU Interrupt
void ISR_Handler_fpu(){ // Interrupt 0x2D - IRQ13 - FPU Interrupt
...
void ISR_Handler_primary_ata(){ // Interrupt 0x2E - IRQ14 - Primary ATA Interrupt
...
void ISR_Handler_secondary_ata(){ // Interrupt 0x2F - IRQ15 - Secondary ATA Interrupt
...
//syscall interrupt
void ISR_Handler_syscall(){
    //call the syscall function
    //dont push the registers as they are parameters
